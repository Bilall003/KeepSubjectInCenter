...
class centerObject():
    ...
    def process_video(self):
        ...
        while self.vid.isOpened():
            ...
            if detect_motion:
                if self.detect_human(self.motion_frame,True) and self.end_x != 0 and self.start_x != 0:
    ...
    def extract_audio(self):
        my_clip = mvp.VideoFileClip(r"test.mp4")
        
        if my_clip.audio == None:
            return False

        my_clip.audio.write_audiofile(r"temp_audio.mp3")
        return True
